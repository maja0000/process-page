        ...
        <div className="all-boxes bounce">
          <div className="content-box">
            ...
            <p style={{ fontWeight: '100', fontSize: '1.5em' }}>
              ...
              To make sure that I know exactly what is my application purpose
          ...
          <div className="content-box">
            ...
            <p style={{ fontWeight: '100', fontSize: '1.5em' }}>
              ...
              Before starting to code I prepare a rough sketch of the user
              interface on a piece of paper. Afterward using Figma I add
              details, collect icons, pictures, fonts, and color palettes I’ll
              be using in the project. <br />
            </p>
          </div>
          <div className="content-box">
          ...
          <div className="content-box">
            ...
            <p style={{ fontWeight: '100', fontSize: '1.5em' }}>
              ...
              methodology as closely as in a team. Despite that, I’ll definitely
              split the task in smaller sprints and estimate how long will they
              take depending on the difficulty and complexity of the tasks. I'll
              set up a deadline for each of them and try to keep the schedule as
          ...
          <div className="content-box">
            ...
            <p style={{ fontWeight: '100', fontSize: '1.5em' }}>
              ...
              Everything is working ? Cool! Now it's time to refracture. I try
              to make everything shorter and more <em>elegant</em> . If
              components ended up being too long, I'll break them down. Maybe
              some functions deserve a separate file? Maybe it would be better
              to make a hook out of them and import in different places in my
              app? Final touches!
              <br />
            </p>
          </div>
